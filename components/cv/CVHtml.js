...
export default function CVHtml({style}) {
    return(
        <>
        <div className="CVHtml-component" style={{ display: 'flex', gap: 10, height: '100vh', ...style}}>
            ...
            <div className="footer" style={{height: '100%', padding: 15, background:'linear-gradient(to bottom right, #0066ff 0%, #6699ff 100%)'}}>
